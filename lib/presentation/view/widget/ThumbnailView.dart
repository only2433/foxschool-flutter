...
class ThumbnailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> resourceIndexImage = [
            ...
            children: [
              Hero(
                ...
                child: FadeInImage.memoryNetwork(
                    ...
                    fit: BoxFit.cover,
                    fadeInDuration: const Duration(milliseconds: Common.DURATION_SHORT),
                    fadeOutDuration: const Duration(milliseconds: Common.DURATION_SHORT),
                    image: imageUrl,
                ),
              ),
              if(level >= 0)
                Positioned(
                  bottom: 0,
                  child: Image.asset(resourceIndexImage[level - 1],
