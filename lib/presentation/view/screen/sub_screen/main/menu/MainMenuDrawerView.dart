...
import 'package:foxschool/presentation/view/widget/GreenOutlinedTextButton.dart';
import 'package:foxschool/presentation/view/widget/IconTextColumnWidget.dart';
...
class MainMenuDrawerView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Logcats.message("userName : $userName , userClass : $userClass");
    return Stack(
       children: [
         ListView(
